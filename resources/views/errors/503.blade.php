...
<head>
    ...
    <title>503 - Joint gyro</title>
    <meta name="description" content="Joint gyro - Restaurant, We use only the best ingredients, it must be fresh in order to be used in our dishes">
        ...
        <div class="col-md-6">
            <div class="error-template">
                ...
                <h1>
                    ...
                    <h1><strong>CALL US TO ORDER</strong></h1>
