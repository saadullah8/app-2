...
<div class="row">
   <div class="col-md-12">
     <div class="box box-info">
      ...
      <form action="{{url('category')}}" method="post" role="form">
        ...
        <div class="row">
         <div class="col-md-6">
           <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
            ...
            <input class="form-control" placeholder="Category E.g Pizza, Burger, Drinks" name="name" type="text" value="{{old('name')}}" autocomplete="off">
