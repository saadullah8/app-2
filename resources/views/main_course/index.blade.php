...
@section('title','Main Course Lists')
@section('style')
        <!-- DataTables -->
 ...
 <div class="box box-info">
       ...
       @endif
        ...
        @endif
         ...
         <h3 class="box-title">Main Course Lists</h3>
              <a href="{{url('main-course/create')}}" class="btn btn-primary pull-right">add Main Course</a>
         </div>
              ...
              <table id="example1" class="table table-bordered table-striped d-table" >
                    ...
                    @foreach($courses as $value)
                        <tr>
                            ...
                            <a href="{{url('main-course/'.encrypt($value->id).'/edit')}}" class="action_imgs">
   ...
   <div class="modal-dialog">
     <div class="modal-content">
       <div class="modal-header">
        ...
        <form action="{{route('main-course.destroy','main')}}" method="post" >
