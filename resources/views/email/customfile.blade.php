        ...
        <table class="table table-striped" cellpadding="0" cellspacing="0">
               ...
               <tbody>
                <tr>
                    ...
                    <td style="border-top: 0px; text-align: right; width:40%; ">{{date('F d, Y')}}<br>{{date('h:i a')}}</td>
               ...
               <tr>
                   @if($value->product_type=='customized')
                      ...
                      <td style="width:60%;"><strong>{{$value->product_name}}
                      ...
                      <td style="text-align: right; width:40%;">${{$value->price}}</td>
                   @endif
